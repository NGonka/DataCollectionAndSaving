...
/*------------------------Main Action-----------------------------------*/
void addPoints(voltPoint, currPoint,rpmPoint,timePoint) {
...
if (!Save)
{
 // table.clearRows();
  ...
  String inString = voltPoint+","+currPoint+","+rpmPoint+","+timePoint;
...
//table class 
//https://github.com/jeresig/processing-js/blob/master/test/parser/Fry-Visualizing-Data/ch03-usmap/step08_rollovers/Table.pde
